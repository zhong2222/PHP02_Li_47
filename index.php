...
<body>
    ...
    <main>
        ...
        <form action="insert.php" method="post">
                ...
                書名：  <input id="title" type="text" class="box" name="title"><br>
                著者：  <input id="author" type="text" class="box" name="author"> <br>
                URL :   <input id="url" type="text" class="box" name="url"><br>       
                開始日: <input id="start" type="date" class="box"  name="start"><br>
                完了日: <input id="end" type="date" class="box"  name="end"><br>
                評価：   <select id="evaluate" type="text" class="box" name="evaluate">
                                <option value="◎">◎</option>
                                <option value="◯">◯</option>
                                <option value="△">△</option>
                                <option value="✕">✕</option>
