...
try {
    ...
    $pdo = new PDO('mysql:dbname=action_reading_db;charset=utf8;host=localhost', 'root', '');
...
$stmt = $pdo->prepare("INSERT INTO
                        gs_bm_table(id, title, author, url, start, end, evaluate, purpuse, thoughts, action, plan, date)
