...
$("#send").on("click",function(){
                ...
                for(let i=0; i<len; i++){
                    ...
                    html += `
                        <tr>
                            ...
                            <td><button data-a=${data.items[i].volumeInfo.infoLink}
                                        data-b=${data.items[i].volumeInfo.imageLinks.thumbnail}
                                        data-c=${data.items[i].volumeInfo.title}
                                        data-d=${data.items[i].volumeInfo.authors}
                                        id="select">選択</button>
                            </td>    
                        </tr>
                    `;
                ...
                let url=$(this).data("a");                   
                let img=$(this).data("b");
                let title =$(this).data("c");
                let author =$(this).data("d");
